...
<div class="maincontent">
	...
	<h4 class="widgettitle">Hal Verifikasi Berkas LPJ UKM</h4>
			...
			$no = 1;
				foreach($lpj as $r){
                    ...
                    <td><a target="_blank" href="<?php echo base_url(); ?>assets/lpj/<?php echo $r['berkas'] ?>"><?php echo $r['berkas'] ?></a></td>
                     <td>
						<a title="Edit Data" href="<?php echo base_url() ?>kemahasiswaan/v_lpj/edit/<?php echo $r['id_lpj']  ?>" class="iconsweets-create"></a>
					</td>
                </tr>
					<?php
				}
